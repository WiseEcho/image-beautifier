            ...
            <div className={cn('max-w-[600px]', stores.editor.invalid && 'invalid')}>
                ...
                >
                    <div className="text-center p-10">
                        ...
                        <p className="text-sm px-4">请点击或拖动图片到这里<br />可以粘贴图片 {modKey} + V </p>
                    </div>
                </Dragger>
                <div className="hidden flex justify-between mt-2 py-4 px-6 rounded-md bg-white dark:bg-black shadow-sm">
